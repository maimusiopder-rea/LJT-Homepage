---
permalink: /
title: "Junteng Liu - PhD Candidate, HKUST NLP Group"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
*(Full list available on my [Google Scholar](https://scholar.google.com/citations?hl=en&user=tbK9jl4AAAAJ&view_op=list_works&sortby=pubdate) profile)*
...
### Co-Author
1. **In-Context Sharpness as Alerts: An Inner Representation Perspective for Hallucination Mitigation** (2024, ICML 2024)
   *Authors: Shiqi Chen, Miao Xiong, Junteng Liu, Zhengxuan Wu, Teng Xiao, Siyang Gao, Junxian He*
2. **C-Eval: A Multi-Level Multi-Discipline Chinese Evaluation Suite for Foundation Models** (2023, NeurIPS 2023)
...
3. **Composing Parameter-Efficient Modules with Arithmetic Operations** (2023, NeurIPS 2023)
